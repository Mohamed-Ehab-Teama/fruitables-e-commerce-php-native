            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8 text-end">
                    <ul class="nav nav-pills d-inline-flex text-center mb-5">
                        ...
                        <?php
                        $result = get_all_records($connection, 'categories');
                        if ($result):
                        ...
                        <!-- ----------------------------------------   end of get Categories From DataBase -->
                    ...
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                <?php
                                $result = get_all_records_from_two_tables($connection, 'products', 'categories', 'products.category_id', 'categories.id');
                                if ($result):
                                    while ($row = mysqli_fetch_assoc($result)):
                                        // var_dump($row);
                                ...
                                ?>
                                <!-- ------------------------------------------- End Of Get All Products From DataBase -->
                    ...
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                <?php
                                $result = get_all_records_from_two_tables_on_check($connection, 'categories', 'products', 'categories.id', 'products.category_id', 'category', 'Vegetables');
                                if ($result):
                                    while ($row = mysqli_fetch_assoc($result)):
                                ?>
                                ...
                                ?>
                                <!-- ------------------------------------- End of Get All Vegetables from Database -->
                    ...
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                <?php
                                $result = get_all_records_from_two_tables_on_check($connection, 'categories', 'products', 'categories.id', 'products.category_id', 'category', 'Fruits');
                                if ($result):
                                    while ($row = mysqli_fetch_assoc($result)):
                                ?>
                                ...
                                <!-- ------------------------------------- End of Get All Fruits from Database -->
                    ...
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                <!-- -------------------------------------  Get All Bread from Database -->

                                <?php
                                $result = get_all_records_from_two_tables_on_check($connection, 'categories', 'products', 'categories.id', 'products.category_id', 'category', 'Bread');
                                if ($result):
                                    while ($row = mysqli_fetch_assoc($result)):
                                ?>
                                ...
                                <!-- ------------------------------------- End of Get All Bread from Database -->
                    ...
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                ...
                                <!-- -------------------------------------  Get All Meat from Database -->

                                <?php
                                $result = get_all_records_from_two_tables_on_check($connection, 'categories', 'products', 'categories.id', 'products.category_id', 'category', 'Meat');
                                if ($result):
                                    while ($row = mysqli_fetch_assoc($result)):
                                ?>
        ...
        <div class="owl-carousel vegetable-carousel justify-content-center">
            ...
            ?>
                    <div class="border border-primary rounded position-relative vesitable-item">
                        ...
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;"> <?php echo $row['category']; ?> </div>
            ...
            ?>
            <!-- --------------------------------------------------------------- End Of Get Vegetables From DataBase -->
